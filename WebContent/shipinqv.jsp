...
<body data-spy="scroll" data-target=".nav-top">
    ...
    <section class="版块速览">
        <div class="container">
            <p align="top" style="font-size: 40"><em class="fa fa-video-camera"></em> 视频区<br><br>
                <hr>
            </p>
        </div>
                ...
                <div class="col-md-7 col-xs-12">
                    <div class="about-img">
                            ...
                            try {
                                ...
                                String sql2 = "select * from videos where block_id=1 order by visit_num desc";
                ...
                <div class="col-md-7 col-xs-12">
                    <div class="about-img">
                            ...
                            try {
                                ...
                                String sql1 = "select * from videos where block_id=2 order by visit_num desc";
                        ...
                        while(rst1.next()){
                            ...
                            int video_user_id = rst1.getInt("video_user_id");
                            String time = rst1.getString("time");
                            int visit_num = rst1.getInt("visit_num");
                            %>
                            <div class="one_post">
                            <hr>
                            <a>
                ...
                <div class="col-md-7 col-xs-12">
                    <div class="about-img">
                        ...
                        try {
                            ...
                            String sql = "select * from videos where block_id=3 order by visit_num desc";
                    ...
                    while(rst.next()){
                        ...
                        //String content = rst2.getString("Content");
                        int video_id = rst.getInt("video_id");
