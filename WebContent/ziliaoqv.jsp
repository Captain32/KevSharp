...
<body data-spy="scroll" data-target=".nav-top">
    ...
    <section class="版块速览">
        <div class="container">
            <p align="top" style="font-size: 40"> <em class="fa fa-paperclip"></em> 资料区<br><br>
                <hr>
            </p>
        </div>
                ...
                <div class="col-md-7 col-xs-12">
                    <div class="about-img">
                            ...
                            try {
                                ...
                                String sql2 = "select * from files where block_id=1 order by reply_num desc";
                                rst2 = stmt2.executeQuery(sql2);
                                %>
                        <%
                        while(rst2.next()){
							String title = rst2.getString("title");  
                            int file_id = rst2.getInt("file_id");
                            String file_user_name = rst2.getString("file_user_name");
                            int file_user_id = rst2.getInt("file_user_id");
                ...
                <div class="col-md-7 col-xs-12">
                    <div class="about-img">
                            ...
                            try {
                                ...
                                String sql1 = "select * from files where block_id=2 order by reply_num desc";
                ...
                <div class="col-md-7 col-xs-12">
                    <div class="about-img">
                        ...
                        try {
                            ...
                            String sql = "select * from files where block_id=3 order by reply_num desc";
                            rst = stmt.executeQuery(sql);
                            %>
                    <%
                    while(rst.next()){
                    	String title = rst.getString("title");                           
                        int file_id = rst.getInt("file_id");
