                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="media">
                                <a href="#视频区">
                                    <div class="media-left media-middle"><i class="fa fa-video-camera"></i></div>
                        ...
                        <div class="col-md-4">
                            <div class="media">
                                <a href="#资料区">
                                    <div class="media-left media-middle"> <i class="fa fa-paperclip"></i> </div>
                                    <div class="media-body">
                                        <h3>资料区</h3>
                        ...
                        <div class="col-md-4">
                            <div class="media">
                                <a href="#论坛区">
                                    <div class="media-left media-middle"> <i class="fa fa-bullhorn"></i> </div>
                                    <div class="media-body">
                                        <h3>论坛区</h3>
                ...
                <div class="col-md-7 col-xs-12">
                    <div class="about-img">
                            ...
                            try {
                                ...
                                String sql2 = "select * from videos order by visit_num desc limit 6";
                        ...
                        while(rst2.next()){
                            ...
                            int video_id = rst2.getInt("video_id");
                            String video_user_name = rst2.getString("video_user_name");
                            int video_user_id = rst2.getInt("video_user_id");
                            String time = rst2.getString("time");
                            int visit_num = rst2.getInt("visit_num");
                            %>
                            <div class="one_post">
                            <hr>
                            <a>
                            <p><a href="video.jsp?video_id=<%=video_id %>"><%=title %></a></p>
                                up主：<a href="user.jsp?show_user_id=<%=video_user_id%>"><%=video_user_name %></a>
                            &emsp;播放数：<%=visit_num %>
                            &emsp;<%=time %><hr>
                            </a>
                            </div>
                ...
                <div class="col-md-7 col-xs-12">
                    <div class="about-img">
                            ...
                            try {
                                ...
                                String sql1 = "select * from files order by reply_num desc limit 6";
                        ...
                        while(rst1.next()){
                            ...
                            int file_id = rst1.getInt("file_id");
                            String file_user_name = rst1.getString("file_user_name");
                            int file_user_id = rst1.getInt("file_user_id");
                            ...
                            <p><a href="show_material.jsp?file_id=<%=file_id %>"><%=title %></a></p>
                                up主：<a href="user.jsp?show_user_id=<%=file_user_id%>"><%=file_user_name %></a>
                            &emsp;浏览量：<%=reply_num %>
                            &emsp;<%=time %><hr>
                            </a>
                            </div>
