...
<html  lang="zh-cmn-Hans">
    ...
    <body data-spy="scroll" data-target=".nav-top">
                ...
                <div class="container" style="background: #FFFFFF">
                    ...
                    <div class="row">
                        <div class="about-content">
                            <br><br>
                                <h1 class="section-title"><em class="fa fa-bullhorn"></em> 发帖</h1>
		...
		<label>内容：</label>
		<br>
		 <textarea name="content" id="content" cols="80" rows="10" style="vertical-align:top;outline:none;"></textarea><br>
		<input id="submitButton"  type="submit" class="btn navbar-btn" value="发布帖子" onclick="javascript:this.form.action='add_post_to_sql.jsp'"/>
