...
<body data-spy="scroll" data-target=".nav-top">
    ...
    <section class="support">
        <div class="container" align="center">
            <form action="" method="post" class="center" align=left>
                <label><font color="white">昵称：</font></label>
                <input name="username" type="text">
                <br />
				<label><font color="white">性别：</font></label>
                <select name="gender" class="list">
                    <option value="male">男</option>
                    <option value="female">女</option>
                </select>
                <br />
                <label><font color="white">生日：</font></label>
                <input name="birthday" type="date">
                <br />
                <label><font color="white">密码：</font></label>
                <input name="password" type="password">
                <br />
                <label><font color="white">邮箱：</font></label>
                <input name="email" type="email">
                <br />
                <input id="submitButton" type="submit" value="提交"
                    onclick="javascript:this.form.action='add_register.jsp'" class="btn navbar-btn"/>
                <input id="return" class="pos_right btn navbar-btn" type="button" value="返回"
                    onclick="javascript:location.href='welcome.jsp'" />
            </form>
        </div>
    </section>
    <!--======== end support =========-->
